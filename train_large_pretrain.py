...
if __name__ == '__main__':
    ...
    train_dataloader, dataset = load_data('./data/HKFinancialStatements_zh_cn.txt', 'train', tokenizer, ratio=1)
    ...
    torch.save(model.state_dict(), "./data/financial_large.pth")  # 只保存模型的参数