...
def train(model, dataloader, optimizer, device, mode="train"):
    ...
    for batch, no_model_batch in tqdm(dataloader):
        ...
        loss_mask = no_model_batch["loss_mask"].view(-1,1024)
...
if __name__ == '__main__':
    ...
    train_dataloader, dataset = load_data('./data/train.txt', 'train', tokenizer, ratio=0.01)
    ...
    for epoch in range(1):
        ...
        torch.save(model.state_dict(), "./data/insurance_large.pth")